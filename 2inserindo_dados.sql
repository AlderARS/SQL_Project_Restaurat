...
-- excluindo uma linha da tabela funcionários
delete from funcionarios WHERE cpf = '222.333.444-55';

-- atualizando uma linha da tabela funcionários
update funcionarios set cargo = 'Garçonete', salario = '2700' where cpf ='444.555.666-77';

-- atualizando todos os status com data inferior a 24-07-06
-- por se tratar de um update em um campo não chave precisei desativar o safe mode (SET SQL_SAFE_UPDATES = 0)
set sql_safe_updates = 0;
update pedidos set status = "ConcluÃ­do" WHERE data_pedido < "2024-07-06";